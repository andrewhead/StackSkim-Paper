...
In an early prototype, we developed a \Gls{name} for visualizing regular expressions, leveraging the third-party visualizer \emph{RegExper} (Figure~\ref{fig:regex_visualization}).
