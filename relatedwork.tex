...
Visual tools have been used to aid in programming instruction; Sorva \cite{sorva_visual_2012} presents a good review.\marti{Note my change in wording and to the reference here.}
...
We believe we are the first to consider building demonstrations from the perspective of writing design guidelines for micro-explanations of code found in online programming help. \marti{what is meant by "design guidelines" here?}
