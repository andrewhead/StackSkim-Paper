...
We augment our discussion with implementation details of two \glspl{name} we developed for CSS selectors and the \texttt{wget} command and \glspl{exp} we generate for regular expressions.
