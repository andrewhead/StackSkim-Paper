...
\Glspl{name} are grammar- or library-specific routines for spinning context-relevant, on-demand explanations of unfamiliar code that users encounter in the wild.
