...
We build \glspl{name} for CSS selectors, regular expressions and the terminal command ``wget''.
...
Through a qualitative study, we show that \gls{name}-generated explanations can reduce the need for reference documentation in code modification tasks. \andrew{Marti wants us to mention insights from the usability study here.}
\end{abstract}
