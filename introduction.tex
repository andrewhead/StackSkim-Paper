...
\centering{%
    ...
    \subfigure[A \gls{exp} describing the high-level intent and low-level argument values of a \texttt{wget} command.\andrew{Update this example, as it `downloads content from None'}]{%
